...
urlpatterns += [
    ...
    path('user/<uuid:user_id>/', views.UserIdViewSet.as_view(), name='user'),
    path('user/me/',  views.UserInfoView.as_view(), name='update_user'),
    path('user/<uuid:user_id>/update/', views.UpdateUserInfoView.as_view(), name='update_specific_user'),
    ...
    path('user/follow/<uuid:followee>/',views.FollowUserDetailsViewSet.as_view(), name='user-follow-detail'),
    ...
    path('user/chat/<uuid:user_id>/',  views.ChatLogViewSet.as_view(), name = 'user-chat-detail'),
