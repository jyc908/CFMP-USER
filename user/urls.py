...
urlpatterns += [
    ...
    path('user/follow/detail/<uuid:followee>/',views.FollowUserDetailsViewSet.as_view(), name='user-follow-detail'),
    ...
    path('user/chat/',  views.ChatLogViewSet.as_view(), name = 'user-chat-detail'),
