...
urlpatterns += [
    ...
    path('user/update/', views.UpdateUserInfoView.as_view(), name='update_specific_user'),
    ...
    path('user/<uuid:user_id>/chat/',  views.ChatLogViewSet.as_view(), name = 'user-chat-detail'),
